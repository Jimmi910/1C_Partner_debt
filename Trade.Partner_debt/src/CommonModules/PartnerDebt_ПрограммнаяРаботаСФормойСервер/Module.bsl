...
Процедура УстановитьМножествоСтруктурСвойствЭлементу(Элемент, СтруктураСвойств1, СтруктураСвойств2 = Неопределено,
	СтруктураСвойств3 = Неопределено, СтруктураСвойств4 = Неопределено, СтруктураСвойств5 = Неопределено,
	СтруктураСвойств6 = Неопределено, СтруктураСвойств7 = Неопределено, СтруктураСвойств8 = Неопределено,
	СтруктураСвойств9 = Неопределено, СтруктураСвойств10 = Неопределено) Экспорт
...
//
Функция СздГруппаОбычнаяБезОтображения(Форма, ИмяГруппы, РодительГруппы, ГруппировкаОбычнойГруппы = 0,
	РастягиватьГоризонтально = 0, РастягиватьВертикально = 0, СтруктураСвойств = Неопределено,
...
//					- Элементы - можно передать элемент формы
//
Функция СздГруппаОбычная(Форма, ИмяГруппы, РодительГруппы, Заголовок = "", ГруппировкаОбычнойГруппы = 0,
	РастягиватьГоризонтально = 0, РастягиватьВертикально = 0, СтруктураСвойств = Неопределено,
	ЭлементПеред = Неопределено) Экспорт
...
//					- Элементы - можно передать элемент формы
//
Функция СздГруппаСтраниц(Форма, ИмяГруппы, РодительГруппы, РастягиватьГоризонтально = 0, РастягиватьВертикально = 0,
	ПриСменеСтраницы = "",	//FIXME GVGold Котов Д.В. 26.03.2020 

	СтруктураСвойств = Неопределено, ЭлементПеред = Неопределено) Экспорт
...
//					- Элементы - можно передать элемент формы
//
Функция СздСтраница(Форма, ИмяСтраницы, ГруппаСтраницы, Заголовок = "", ГруппировкаОбычнойГруппы = 0,
	РастягиватьГоризонтально = 0, РастягиватьВертикально = 0, СтруктураСвойств = Неопределено,
...
//					- Элементы - можно передать элемент формы
//
Функция СздГруппаКоманднаяПанель(Форма, ИмяПанели, РодительПанели, СтруктураСвойств = Неопределено,
	ЭлементПеред = Неопределено) Экспорт
...
//					- Элементы - можно передать элемент формы
//
Функция СздГруппа(Форма, ИмяГруппы, РодительГруппы, СтруктураСвойств, ЭлементПеред = Неопределено) Экспорт
...
//					- Элементы - можно передать элемент формы
//
Функция СздПоле(Форма, ИмяПоля, Знач РодительПоля, Заголовок, ШифрВидаПоля = 0, ПутьКДанным = "",
	СтруктураСвойств = Неопределено, СтруктураСобытий = Неопределено, ЭлементПеред = Неопределено) Экспорт
...
//					- Элементы - можно передать элемент формы
//
Функция СздПолеФлажок(Форма, ИмяПоля, РодительПоля, Заголовок, тВидФлажка = 0, ПутьКДанным = "",
	СтруктураСвойств = Неопределено, СтруктураСобытий = Неопределено, ЭлементПеред = Неопределено) Экспорт

	НовыйЭлемент = СздПоле(Форма, ИмяПоля, РодительПоля, Заголовок, 2, ПутьКДанным, СтруктураСвойств, СтруктураСобытий,
		ЭлементПеред);
...
//					- Элементы - можно передать элемент формы
//
Функция СздДекорацияНадпись(Форма, ИмяДекорации, РодительДекорации, ЗаголовокДекорации,
	РастягиватьПоГоризонтали = Истина, ЭлементПеред = Неопределено) Экспорт
...
//					- Элементы - можно передать элемент формы
//
Функция СздДекорацияКартинка(Форма, ИмяДекорации, РодительДекорации, ИмяКартинки, ЭлементПеред = Неопределено) Экспорт
...
//					- Элементы - можно передать элемент формы
//
Функция СздДекорация(Форма, ИмяДекорации, РодительДекорации, СтруктураСвойств = Неопределено,
	СтруктураСобытий = Неопределено, ЭлементПеред = Неопределено) Экспорт
...
//					- Элементы - можно передать элемент формы
//
Функция СздКнопка(Форма, ИмяКнопки, РодительКнопки, ЗаголовокКнопки = "", ИмяКоманды = "", ВидКнопки = 0,
	СтруктураСвойств = Неопределено, ЭлементПеред = Неопределено) Экспорт
...
Функция СздДинамическийСписок(Форма, ИмяСписка = "Список", РодительСписка, ТекстЗапроса = "",
	...
	СтруктураСвойств = Неопределено, СтруктураСобытий = Неопределено, СвояКоманднаяПанель = Ложь,
	ЭлементПеред = Неопределено) Экспорт
	...
	ТаблицаФормы = СздТаблицаФормы(Форма, ИмяСписка, РодительСписка, ИмяСписка, СтруктураКолонок, СтруктураСвойств,
		СтруктураСобытий, СвояКоманднаяПанель, ЭлементПеред);
...
//					- Элементы - можно передать элемент формы
//
Функция СздКолонкаТаблицыФормы(Форма, ИмяКолонки, Родитель, ТипКолонки = 0, Заголовок = "", ПутьКДанным,
	ОтображатьШапку = Истина, ОтображатьПодвал = Ложь, СтруктураСвойств = Неопределено, СтруктураСобытий = Неопределено,
	ЭлементПеред = Неопределено) Экспорт
...
//					- Элементы - можно передать элемент формы
//
Функция СздТаблицаФормы(Форма, ИмяТаблицы, РодительТаблицы, ПутьКДанным, СтруктураКолонок = Неопределено,
	СтруктураСвойств = Неопределено, СтруктураСобытий = Неопределено, СвояКоманднаяПанель = Ложь,
	ЭлементПеред = Неопределено) Экспорт
	...
	Если СвояКоманднаяПанель Тогда
		ГруппаДинамическогоСписка = СздГруппаОбычнаяБезОтображения(Форма, "ДополнительнаяГруппаКоманднаяПанель"
...
//					- Элементы - можно передать элемент формы
//
Функция СздГруппаКолонокТаблицыФормы(Форма, ИмяГруппы, РодительГруппы, ГруппировкаГруппы = 0,
	РастягиватьГоризонтально = 0, ОтображатьВШапке = Ложь, Заголовок = "", СтруктураСвойств = Неопределено,
	ЭлементПеред = Неопределено) Экспорт
...
Функция СздВыпадающийСписок(Форма, ИмяСписка, РодительСписка, ЗаголовокЭлемента = "", МассивЗначений,
	РедактированиеТекста = Ложь, СтруктураСвойств = Неопределено, СтруктураСобытий = Неопределено,
	ЭлементПеред = Неопределено) Экспорт

	СоздатьРеквизит(Форма, ИмяСписка, ОписаниеТипаСтрока(100));
	//НовыйРеквизит = Форма[ИмяСписка];
	НовыйЭлемент = СздПоле(Форма, ИмяСписка, РодительСписка, ЗаголовокЭлемента, 1, ИмяСписка, СтруктураСвойств,
		СтруктураСобытий, ЭлементПеред);
...
Функция СздПереключатель(Форма, ИмяПереключателя, РодительЭлемента, ЗаголовокЭлемента = "", МассивЗначений,
	тВидПереключателя, СтруктураСвойств = Неопределено, СтруктураСобытий = Неопределено, ЭлементПеред = Неопределено) Экспорт

	СоздатьРеквизит(Форма, ИмяПереключателя, ОписаниеТипаЧисло(10, 0));
	//НовыйРеквизит = Форма[ИмяПереключателя];
	НовыйЭлемент = СздПоле(Форма, ИмяПереключателя, РодительЭлемента, ЗаголовокЭлемента, 4, ИмяПереключателя,
...
//
Функция СтруктураСвойствОсновные(Заголовок = "", Вид = Неопределено, ПутьКДанным = "", ПоложениеЗаголовка = Неопределено,
	Видимость = Неопределено, Доступность = Неопределено, ТолькоПросмотр = Неопределено,
	ПропускатьПриВводе = Неопределено, АктивизироватьПоУмолчанию = Неопределено, Маска = "", РежимПароля = Неопределено,
	МногострочныйРежим = Неопределено, РасширенноеРедактирование = Неопределено, Гиперссылка = Неопределено) Экспорт
...
Функция СтруктураСвойствПодсказка(Подсказка = Неопределено, ОтображениеПодсказки = Неопределено,
...
//		0 - Авто
//
Функция СтруктураСвойствРасположение(Ширина = Неопределено, Высота = Неопределено, АвтоМаксимальнаяШирина = Неопределено,
	МаксимальнаяШирина = Неопределено, АвтоМаксимальнаяВысота = Неопределено, МаксимальнаяВысота = Неопределено,
	РастягиватьПоГоризонтали = Неопределено, РастягиватьПоВертикали = Неопределено,
	тГоризонтальноеПоложение = Неопределено, тГоризонтальноеПоложениеВШапке = Неопределено,
	...
	Если тГоризонтальноеПоложение <> Неопределено Тогда
		СтруктураСвойств.Вставить("ГоризонтальноеПоложение", ПолучитьГоризонтальноеПоложение(
			тГоризонтальноеПоложение));
	КонецЕсли;
	Если тГоризонтальноеПоложениеВШапке <> Неопределено Тогда
		СтруктураСвойств.Вставить("ГоризонтальноеПоложениеВШапке", ПолучитьГоризонтальноеПоложение(
			тГоризонтальноеПоложениеВШапке));
	КонецЕсли;
	Если тГоризонтальноеПоложениеВПодвале <> Неопределено Тогда
		СтруктураСвойств.Вставить("ГоризонтальноеПоложениеВПодвале", ПолучитьГоризонтальноеПоложение(
			тГоризонтальноеПоложениеВПодвале));
	КонецЕсли;
...
Функция СтруктураСвойствТаблицыФормы(Отображение = Неопределено, РежимВводаСтрок = Неопределено,
	РежимВыделения = Неопределено, РежимВыделенияСтроки = Неопределено, Шапка = Неопределено, Подвал = Неопределено,
